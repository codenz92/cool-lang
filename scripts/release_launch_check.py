...
def validate(args):
    ...
    for rel, needle, label in [
        ...
        ("apps/release_audit.cool", "Phase 31", "release audit checks current roadmap phase"),
        ("scripts/release_gate.sh", "package_publication_check.sh", "release gate runs publication check"),
        ("scripts/release_gate.sh", "package_submission_packet.sh", "release gate runs submission packet ledger check"),
        ...
        (".github/workflows/release-validation.yml", "package_submission_packet.sh", "release validation workflow runs submission packet check"),
        ...
        (".github/workflows/release-matrix.yml", "package_submission_packet.sh", "release matrix workflow runs submission packet check"),
        ...
        (".github/workflows/published-release.yml", "package_submission_packet.sh", "published-release workflow runs submission packet check"),
        (".github/workflows/package-submission-review.yml", "package_submission_packet.sh", "package submission review workflow runs packet check"),
        ...
        ("docs/RELEASE_VALIDATION.md", "package_submission_packet.sh", "release validation docs include submission packet check"),
        ...
        ("docs/README.md", "PACKAGE_SUBMISSION_REVIEW.md", "docs index links package submission review"),
        ("ROADMAP.md", "Phase 31", "roadmap records Phase 31"),
    ]:
