...
`scripts/package_publication_check.sh`, run
`scripts/package_submission_packet.sh`, and verify the uploaded channel archive
...
`docs/PACKAGE_MANAGER_SUBMISSIONS.md`, submission review packet workflow in
`docs/PACKAGE_SUBMISSION_REVIEW.md`, and publication ledger in
