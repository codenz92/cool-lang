...
- `apps/release_audit.cool` — Phase 27 repo-health audit for distribution,
  conformance, docs, release workflows, and package-channel readiness.
...
and stdlib behavior. It fails when required Phase 26/27 docs, conformance
assets, release scripts, or workflows are missing.
